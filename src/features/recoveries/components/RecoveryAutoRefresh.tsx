...
export function RecoveryAutoRefresh({
  intervalMs = 15000,
}: RecoveryAutoRefreshProps) {
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          <p className="font-bold text-blue-950">
            Atualização automática {enabled ? "ativa" : "pausada"}
          </p>

          <p className="mt-1 text-xs text-blue-700">
            A lista é atualizada a cada {Math.floor(intervalMs / 1000)} segundos.
